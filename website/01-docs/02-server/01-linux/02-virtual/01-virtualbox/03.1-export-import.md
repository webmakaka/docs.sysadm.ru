...
$ export VM_BACKUPS=${VM_HOME}/backups/2026.01.10
```
...
Установить <a href="https://gitops.ru//tools/virtual/virtualbox/setup/ubuntu/">Extension Packs</a> (Там присутствуют какие-то лицензионные огранчения).
