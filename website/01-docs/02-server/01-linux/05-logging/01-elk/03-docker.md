...
permalink: /linux/server/linux/logging/elk/docker/
---
...
![elk docker](/img/server/linux/logging/elk/intall/elk-docker.png 'elk docker'){: .center-image }
...
Инсталлируем <a href="https://gitops.ru/devops/containers/docker/setup/ubuntu/">docker и docker-compose</a>.
