...
2026.07.26 - 1 час (Не удается получить от провайдера параметры по DHCP)
...
2025.11.25 - 1,5 часа (Не удается получить от провайдера параметры по DHCP)
...
2024.06.11 - 4,5 часа (Не удается получить от провайдера параметры по DHCP)
...
### Предлагаю, по возможности, отключаться от услуг таких гигантов как РосТелеком, МТС, МГТС, Билайн, Мегафон, Теле2 в пользу небольших компаний! Не забывайте, что именно из-за просьбы гигантов (официальная версия) нам отключили возможность общаться голосом в telegram, whatsapp и теперь за каждую минут разговора, нам необходимо платить деньги.
